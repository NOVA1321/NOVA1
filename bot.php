...
if(!file_exists('config.json')){
	$token = readline('Hi NOVA Enter Token: ');
	$id = readline('Hi NOVA Enter Id: ');
      ...
      $accounts = json_decode(file_get_contents('accounts.json'),1);
			if(isset($update->message)){
              ...
              $bot->sendphoto([ 'chat_id'=>$chatId,
                  'photo'=>"https://t.me/hack151/1497",
                   'caption'=>'التفعيل بواسطة المطور NOVA 🍻',
                  'reply_markup'=>json_encode([
                      'inline_keyboard'=>[
                          [['text'=>'تسجيل بحساب وهمي🌿','callback_data'=>'login']],
                         [['text'=>"فيديو تعليم الصيد من البوت", 'url'=>"https://t.me/UIYIUOIII/2"]],
                      ]
                  ])
              ]); 
...
لمراسه المطور - @M_a0z",
                  'reply_markup'=>json_encode([
					...
					$bot->sendphoto([
							'chat_id'=>$chatId,
							'photo'=> "https://t.me/UIYIUOIII/2",
							 'caption'=>'البوت مدفوع 💲 و ليس مجاني 👁‍🗨
لشراء نسخه مراسلةة المطور 👁‍🗨',
                  'reply_markup'=>json_encode([
                      'inline_keyboard'=>[
                          [['text'=>'▫️| 『 المطور』','url'=>'t.me/M_a0z']],
                          [['text'=>"قناة المطور  ℡ᴖ̈💜✨⋮", 'url'=>"t.me/hack151"]],
                          [['text'=>"طريقة تفعيل بوت صيد على تيرميكس 🔥", 'url'=>"https://t.me/UIYIUOIII/2"]]
                      ]
                  ])
              ]);   
				}
